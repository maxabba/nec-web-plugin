...
if (!class_exists(__NAMESPACE__ . '\TrigesimoBulkUpdate')) {
    class TrigesimoBulkUpdate
    {
        public function __construct()
        {
            ...
            add_action('wp_ajax_update_trigesimo_dates', [$this, 'ajax_update_trigesimo_dates']);
        }
        ...
        public function add_submenu()
        {
            add_submenu_page(
                ...
                'Aggiorna Date Trigesimo',
                'Aggiorna Date Trigesimo',
                'manage_options',
                'dokan-update-trigesimo-dates',
        ...
        public function render_admin_page()
        {
            ?>
            <div class="wrap">
                <h1>Aggiorna Date Trigesimo</h1>

                <div class="notice notice-info">
                    <p>
                        Questa utility aggiorna i campi <code>trigesimo_data</code> dal formato "YYYY-MM-DD" al formato
                ...
                <div class="card" style="max-width: 800px; margin-top: 20px; padding: 20px;">
                    ...
                    <p>Clicca il pulsante sotto per aggiornare tutti i post di tipo "trigesimo".</p>
                ...
                jQuery(document).ready(function ($) {
                    $('#start-update').on('click', function () {
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {
                                action: 'update_trigesimo_dates',
                                nonce: '<?php echo wp_create_nonce('update_trigesimo_dates'); ?>'
                            },
         ...
         */
        public function ajax_update_trigesimo_dates()
        {
            // Verifica il nonce per la sicurezza
            if (!isset($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'update_trigesimo_dates')) {
            ...
            $results = $this->bulk_update_trigesimo_dates();
         ...
         */
        private function bulk_update_trigesimo_dates()
        {
            ...
            // Query per tutti i post di tipo trigesimo
            $args = [
                'post_type' => 'trigesimo',
            ...
            $trigesimo_posts = get_posts($args);
            $results['total'] = count($trigesimo_posts);

            foreach ($trigesimo_posts as $post_id) {
                // Recupera il valore corrente della data direttamente dal meta
                $current_date = get_post_meta($post_id, 'trigesimo_data', true);
